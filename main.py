...
Config = {
    ...
    "Bot Icon": "..", # will be in all embeds
    ...
    "Coinflip" : { # Config for coinflip
        "1v1" : "..",  # Channel That Coinflips Be In
        "House": 3.5 # House Edge (%)
    },
    "Rains" : { # Config for rains
        "Channel" : "..", # Set to the id the channel rains will be in
    },
    "AdminCommands" : {
        "UserID" : [".."], # user id (only put your user id) for setgems, confirmdeposit, addgems, removegems
    },
    "AutoDeposits" : {
        "Webhook" : "..RJ5nhD1lzvTPFE4cOtM3qux3UOdfdgPNnAsr0GCaUs032s_X_FNiE5gRqNsjK8Cc70-f", # auto deposits or /confirmdeposit
    },
    "Affiliates" : {
        "Webhook" : "..bSNvO3QU7qwKrhvbXLXAtoynPDHXIJMTiroEk9DJoaVAySv8Wp2NAb8cHnxQgC7qEcCY", # webhook for when someone gets affiliated
    },
    "Tips" : {
        "Webhook" : "..ijR1V94nCTsQtcfPdsuLXEPYJN81t3yAlKTIaT2EOM-goMYbGrwbi5_7QawmkJYkfl", # webhook for tips
    },
    "Promocodes" : {
        "Webhook" : "..wpoNlWJQ2kKnUuQ5RO1T7Fo_PBURS0KEoT_Qa17le42bqjq3bZ-b82gGR3t_", # webhook for promocodes
    ...
    "DiscordBotToken": "...GyCnVB...." # The token of the discord bot
}
